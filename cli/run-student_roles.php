...
require_once( dirname( __FILE__ ) . '/../includes/class.tvs-pmp-hwcsextensions.php' );


$set_prefix = 'tvs-moodle-parent-provisioning-';
$provisioner = new TVS_PMP_HWCSExtensions(
...
$provisioner->add_student_roles(ldap,'ou=Students');
